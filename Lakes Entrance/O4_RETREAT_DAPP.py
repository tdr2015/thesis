...
#    annual_MSL=annual_MSL[5:6]
    ...
    ##############################################################     
    ##############################################################
        # Create a subset of the proporty database with zones 1, 2, 3, 4 only     
        ...
        prop_imp_samp = prop_imp_sub.loc[prop_imp_sub['sample']=='N'] #Sample from those remianing propoerties
...
#        if 2035 < year_imp:    #i.e. retreat does not commence until 2030     
            ...
            if nn > 0:
                prop_imp_sub_sel = pd.DataFrame(prop_imp_samp.sample(nn)) #Sample from remaining properties
                sample3 =[]
                for index, x in prop_imp_sub_sel.iterrows():
                    Count = 'Y'
                    sample3.append(Count)         
                prop_imp_sub_sel['samp3'] = sample3 #Tag sampled properties with 'Y'
    
            # Replace the values in the original prop_impact dataset 
...
#annual_MSL_outfile_two = "C:\\Users\\tdramm\\Desktop\\GIS_LE\\zzCODE_TESTING\\"+date_string+"_annual_msl_op4.csv"
...
fig.savefig('C:\\Users\\tdramm\\Desktop\\GIS_LE\\zzCODE_TESTING\\'+date_string+'_scenarios_op4'+'.png',dpi=300,bbox_inches='tight')
plt.show()
...
plt.xticks([1],["Option 4: Retreat"])
plt.ylim(min(cases_dapp['ATP_AAD'])-5)
plt.ylim(2015,2100) # Years
#plt.xlabel('Existing System')
plt.ylabel('Year')
plt.text(1.1, sign_median-6, "Median = " + str(sign_median), fontsize = 7)
...
fig2.savefig('C:\\Users\\tdramm\\Desktop\\GIS_LE\\zzCODE_TESTING\\'+date_string+'_boxplot_op4'+'.png',dpi=300)
plt.show()
...
Cases_outfile_two = "C:\\Users\\tdramm\\Desktop\\GIS_LE\\zzCODE_TESTING\\"+date_string+"_Case_Results_DAPP_OPTION4.csv"
