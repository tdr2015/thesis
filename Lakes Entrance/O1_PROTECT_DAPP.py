...
#        prop_impact = prop_impact[0:10]     # For troubleshooting
        ...
        for index, k in prop_impact.iterrows():            
            ...
            if k['ZONE'] == ('Zone1' or 'Zone2' or 'Zone 3') and k['0.1%_AEP'] < crest and j['Year_Date'] > year_imp: # conditions
...
#            NO_PPL_PT_ONE.append(People)
            ...
            if k['ZONE'] == ('Zone1' or 'Zone2' or 'Zone 3') and k['0.2%_AEP'] < crest and j['Year_Date'] > year_imp: # conditions
...
#            NO_PPL_PT_TWO.append(People)
            ...
            if k['ZONE'] == ('Zone1' or 'Zone2' or 'Zone 3') and k['0.5%_AEP'] < crest and j['Year_Date'] > year_imp: # conditions
...
#            NO_PPL_PT_FIVE.append(People)
            ...
            if k['ZONE'] == ('Zone1' or 'Zone2' or 'Zone 3') and k['1%_AEP'] < crest and j['Year_Date'] > year_imp: # conditions
...
#            NO_PPL_ONE.append(People)
        ...
        # Repeat for AEP 2%, 5%, 10%
            if k['ZONE'] == ('Zone1' or 'Zone2' or 'Zone 3') and k['2%_AEP'] < crest and j['Year_Date'] > year_imp: # conditions
...
#          
            if k['ZONE'] == ('Zone1' or 'Zone2' or 'Zone 3') and k['5%_AEP'] < crest and j['Year_Date'] > year_imp: # conditions
...
#            
            ...
            if k['ZONE'] == ('Zone1' or 'Zone2' or 'Zone 3') and k['10%_AEP'] < crest and j['Year_Date'] > year_imp: # conditions
...
#            NO_PPL_TEN.append(People)
            ...
            if k['ZONE'] == ('Zone1' or 'Zone2' or 'Zone 3') and k['20%_AEP'] < crest and j['Year_Date'] > year_imp: # conditions
                damage_index_str_twenty = 0
                damage_index_con_tewnty = 0
            else:
...
#            NO_PPL_TWENTY.append(People)
            ...
            if k['ZONE'] == ('Zone1' or 'Zone2' or 'Zone 3') and k['40%_AEP'] < crest and j['Year_Date'] > year_imp: # conditions
...
#            NO_PPL_FORTY.append(People)
            ...
            if k['ZONE'] == ('Zone1' or 'Zone2' or 'Zone 3') and k['60%_AEP'] < crest and j['Year_Date'] > year_imp: # conditions
...
#            NO_PPL_SIXTY.append(People)
            ...
            if k['ZONE'] == ('Zone1' or 'Zone2' or 'Zone 3') and k['90%_AEP'] < crest and j['Year_Date'] > year_imp: # conditions
...
#            NO_PPL_NINETY.append(People)
        ...
        if j['Year_Date'] <= year_imp:
            fld_pt_one_lookup = float(aape_lookup.loc[aape_lookup['Flood_level']==round(j['aep_pt_one'],2), 'NO_OP_AAPE'])
            ppl_pt_one = fld_pt_one_lookup*(1+r_ppl*year_ppl)
            ...
            ppl_pt_two = fld_pt_two_lookup*(1+r_ppl*year_ppl)
            ...
            ppl_pt_five = fld_pt_five_lookup*(1+r_ppl*year_ppl)
            ...
            ppl_forty = fld_forty_lookup*(1+r_ppl*year_ppl)
            ...
            ppl_sixty = fld_sixty_lookup*(1+r_ppl*year_ppl)
            ...
            ppl_ninety = fld_ninety_lookup*(1+r_ppl*year_ppl)
            NO_PPL_NINETY.append(ppl_ninety)   

        else:            # Includes NEW barrier and gradual retreat in zone 4
            slr_name = int(100*round(j['aep_pt_one'],2))        
            Comparing_list = pd.read_csv("C:\\Users\\tdramm\\Desktop\\GIS_LE\\AAPE_Lookup\\Log\\Option1\\"+str(slr_name)+"_houses_op_one.csv")
...
#    ax3.set_xticklabels([])
    ...
    plt.yticks(np.arange(0,80000001,20000000))
#    plt.xlim(2010,2120)
...
#annual_MSL_outfile_two = "C:\\Users\\tdramm\\Desktop\\GIS_LE\\zzCODE_TESTING\\"+date_string+"_annual_msl_op1.csv"
...
fig.savefig('C:\\Users\\tdramm\\Desktop\\GIS_LE\\zzCODE_TESTING\\'+date_string+'_scenarios_op1'+'.png',dpi=300,bbox_inches='tight')
plt.show()
...
plt.xticks([1],["Option 1: Protect"])
plt.ylim(min(cases_dapp['ATP_AAD'])-5)
plt.ylim(2015,2100) # Years
#plt.xlabel('Existing System')
plt.ylabel('Year')
plt.text(1.1, sign_median-2, "Median = " + str(sign_median), fontsize = 7)
...
plt.text(1.1, np.percentile(cases_dapp["ATP_AAD"],75)-4, "Q3 = " + str(int(np.percentile(cases_dapp["ATP_AAD"],75))), fontsize = 7)
plt.title('(a) AAD')
...
plt.text(1.1, np.percentile(cases_dapp["ATP_AAPE"],25)-8, "Q1 = " + str(int(np.percentile(cases_dapp["ATP_AAPE"],25))), fontsize = 7)
...
fig2.savefig('C:\\Users\\tdramm\\Desktop\\GIS_LE\\zzCODE_TESTING\\'+date_string+'_boxplot_op1'+'.png',dpi=300)
plt.show()
...
Cases_outfile_two = "C:\\Users\\tdramm\\Desktop\\GIS_LE\\zzCODE_TESTING\\"+date_string+"_Case_Results_DAPP_OPTION1.csv"
